...
data {
  ...
  int use_wghs_;         // TODO: remove - more COMPLICATED ...
  int use_hdr2_;
...
transformed data {
  real wgh_lower_bound = 0.9999999999; // TODO: remove - more COMPLICATED ... 
  real q41_flow_upper_bound = 1e-14;   // TODO: all q41_flow_upper_bound and q41_flow can be removed
...
parameters {
  ...
  // TODO: remove - more COMPLICATED ... PRACTICALLY NOT USED!
  // 0 parameters
